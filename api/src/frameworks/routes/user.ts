...
export class UserRoutes{
    ...
    private configureRoutes():void{
        this._router.get('/user',authMiddleware.verifyAuth.bind(authMiddleware),authMiddleware.verifyAuthRole([ROLES.USER]),authMiddleware.blockChecker.bind(authMiddleware),userController.getDetails.bind(userController))
