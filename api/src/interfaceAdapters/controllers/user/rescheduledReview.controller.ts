...
@injectable()
export class UserRescheduledReviewController implements IUserRescheduledReviewController{
    ...
    async getRescheduledReview(req:Request,res:Response):Promise<void>{
        ...
        const rescheduledReview=await this._getRescheduledReviewUsecase.execute(reviewId)
