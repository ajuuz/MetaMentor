...
const Waiting = ({startTime,now,start}:Props) => {
     ...
     <Card className="h-full">
            ...
            <CardContent className="flex flex-col items-center justify-center h-full space-y-6">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-semibold text-slate-900 mb-2">Review Not Started Yet</h3>
                <p className="text-slate-600 mb-4">
                  Your review session will begin in <span className="font-semibold text-blue-600">{getTimeUntilStart()}</span>
                </p>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-6 w-full max-w-md text-center">
                ...
                <p className="font-semibold text-slate-900">
                  {formattedIsoDate(startTime)} at {toTimeString(start)}
                </p>
              </div>
