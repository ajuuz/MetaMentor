...
import type { LevelFormData } from "@/types/levelTypes";
...
type Props = {
  triggerer: ReactNode;
  mode: "create" | "edit";
  submitHandler: (level: LevelFormData) => void;
  initialData?: CreateLevelReq;
};
...
const LevelDialog = ({
  ...
  const onSubmit = (data: CreateLevelReq) => {
    ...
    let outputData: LevelFormData = { ...data };
    if (mode === "edit") {
      outputData._id = initialData?._id;
      outputData.isBlocked = initialData?.isBlocked;
    }

    submitHandler(outputData);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Textarea
                  id="taskFile"
                  {...register("taskFile")}
                  placeholder="Enter the task file"
                />
                {errors.taskFile && (
                  <p className="text-red-500 text-sm">
        ...
        <DialogFooter className="mt-5">
          ...
          {/* IMPORTANT: Trigger handleSubmit explicitly */}
