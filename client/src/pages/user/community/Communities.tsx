...
import { useGetAllCommunitiesForStudentQuery } from "@/hooks/communitry";
...
const Communities = () => {
    ...
    const {data:enrolledCommunities,isLoading,isError}=useGetAllCommunitiesForStudentQuery(currentPage,10);
     useEffect(()=>{
  ...
  return (
    <div className="flex flex-col justify-center items-center py-5 gap-5">
      ...
      <CardContent>
        <p className="text-sm text-gray-700 line-clamp-3">{domain.description}</p>
      </CardContent>
    </Card>
    )}
    <div>
