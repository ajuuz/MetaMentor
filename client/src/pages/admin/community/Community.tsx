...
import { useAdminGetAllCommunitiesQuery } from "@/hooks/tanstack/communitry";
        ...
        return {
          ...
          content: [
            ...
            <AlertDialogComponent
              alertTriggerer={<Switch checked={community.isBlocked} />}
              alertDescription="This action cannot be undone. This will permanently delete your
                    account and remove your data from our servers."
              handleClick={() =>
                handleStatusChange(community.communityId, !community.isBlocked)
              }
            />,
          ],
        };
